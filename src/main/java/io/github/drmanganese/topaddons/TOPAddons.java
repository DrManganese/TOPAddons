...
@Mod(modid = Reference.MOD_ID, name = Reference.MOD_NAME, version = Reference.VERSION, acceptedMinecraftVersions = "[1.9.4,1.10.2]", dependencies = "after:TheOneProbe;after:forestry;after:tconstruct;after:bloodmagic;after:StorageDrawers;after:Botania")
