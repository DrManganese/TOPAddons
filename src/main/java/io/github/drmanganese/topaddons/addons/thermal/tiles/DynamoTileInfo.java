...
public class DynamoTileInfo implements ITileInfo<DynamoTileBase> {
    ...
    @Override
    public void addProbeInfo(ProbeMode probeMode, IProbeInfo probeInfo, Player player, net.minecraft.world.level.Level world, BlockState blockState, IProbeHitData hitData, @Nonnull DynamoTileBase tile) {
        if (tile.isActive)
