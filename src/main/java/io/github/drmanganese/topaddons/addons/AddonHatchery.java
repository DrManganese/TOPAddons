    ...
    public void addProbeInfo(ProbeMode mode, IProbeInfo probeInfo, EntityPlayer player, World world, IBlockState blockState, IProbeHitData data) {
        ...
        if (tile instanceof EggNestTileEntity) {
            ...
            if (nest.getStackInSlot(0) != null) {
                probeInfo.text(TextFormatting.YELLOW + nest.getStackInSlot(0).getDisplayName());
            ...
            if (entity != null) {
                ...
                textPrefixed(probeInfo, "Next drop", minutes == 0 ? String.format("%d\"", seconds) : String.format("%d'%d\"", minutes, seconds));
