...
public class ElementForestryFarm implements IElement {
    ...
    public void render(int x, int y) {
        ...
        renderItemStack(minecraft, minecraft.getRenderItem(), farmIcons[0], centerX, centerY - 17, I18n.format("for.gui.solder." + oneDirection));
        renderItemStack(minecraft, minecraft.getRenderItem(), farmIcons[1], centerX + 19, centerY + 2, I18n.format("for.gui.solder." + nextDirection()));
        renderItemStack(minecraft, minecraft.getRenderItem(), farmIcons[2], centerX, centerY + 21, I18n.format("for.gui.solder." + nextDirection()));
        renderItemStack(minecraft, minecraft.getRenderItem(), farmIcons[3], centerX - 19, centerY + 2, I18n.format("for.gui.solder." + nextDirection()));
        nextDirection();
